  ...
  <div class="new_interview">
    ...
    <transition name="fade">
      ...
      >
        ...
        <CInput name="interviewYoutubeCode">
          <template #label
            >¡Ingresa el código de Youtube de la entrevista!</template
          >
          <input
            class="interview__code"
            type="text"
            ref="code"
            name="interviewYoutubeCode"
            id="interviewYoutubeCode"
          ...
          <div class="interview__code_suggestion" v-show="interviewCode">
            <youtube :video-id="interviewCode"> </youtube>
            <p>
              https://www.youtube.com/watch?v=<span>{{ interviewCode }}</span>
            </p>
          </div>
        </CInput>
        ...
        <div class="new_interview__form_buttons">
          ...
          <CButton type="submit" class="new_interview__form_submit">
            ...
            <slot name="submitText"> Agregar al listado </slot>
          </CButton>
        </div>
      </form>
    </transition>
...
export default {
  ...
  methods: {
    ...
    ...mapMutations(["setInterviewName", "setInterviewCode", "addAlert"]),
